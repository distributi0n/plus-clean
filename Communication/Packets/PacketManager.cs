namespace Plus.Communication.Packets
{
    ...
    using Incoming.GameCenter;
    using Incoming.Groups;
    using Incoming.Handshake;
    using Incoming.Help;
    using Incoming.Inventory.Achievements;
    using Incoming.Inventory.AvatarEffects;
    using Incoming.Inventory.Badges;
    using Incoming.Inventory.Bots;
    using Incoming.Inventory.Furni;
    using Incoming.Inventory.Pets;
    using Incoming.Inventory.Purse;
    using Incoming.Inventory.Trading;
    using Incoming.LandingView;
    using Incoming.Marketplace;
    using Incoming.Messenger;
    using Incoming.Misc;
    using Incoming.Moderation;
    using Incoming.Navigator;
    using Incoming.Quests;
    using Incoming.Rooms.Action;
    using Incoming.Rooms.AI.Bots;
    using Incoming.Rooms.AI.Pets;
    using Incoming.Rooms.AI.Pets.Horse;
    using Incoming.Rooms.Avatar;
    using Incoming.Rooms.Chat;
    using Incoming.Rooms.Connection;
    using Incoming.Rooms.Engine;
    using Incoming.Rooms.FloorPlan;
    using Incoming.Rooms.Furni;
    using Incoming.Rooms.Furni.LoveLocks;
    using Incoming.Rooms.Furni.Moodlight;
    using Incoming.Rooms.Furni.RentableSpaces;
    using Incoming.Rooms.Furni.Stickys;
    using Incoming.Rooms.Furni.Wired;
    using Incoming.Rooms.Furni.YouTubeTelevisions;
    using Incoming.Rooms.Settings;
    using Incoming.Sound;
    using Incoming.Talents;
    using Incoming.Users;
    using log4net;
    ...
    public sealed class PacketManager
    {
        ...
        private void RegisterCatalog()
        {
            ...
            _incomingPackets.Add(ClientPacketHeader.GetGiftWrappingConfigurationMessageEvent,
                new GetGiftWrappingConfigurationEvent());
            _incomingPackets.Add(ClientPacketHeader.GetMarketplaceConfigurationMessageEvent,
                new GetMarketplaceConfigurationEvent());
        ...
        private void RegisterMarketplace()
        {
            ...
            _incomingPackets.Add(ClientPacketHeader.GetMarketplaceCanMakeOfferMessageEvent,
                new GetMarketplaceCanMakeOfferEvent());
        ...
        private void RegisterRoomSettings()
        {
            ...
            _incomingPackets.Add(ClientPacketHeader.SaveEnforcedCategorySettingsMessageEvent,
                new SaveEnforcedCategorySettingsEvent());
        }
        ...
        private void FloorPlanEditor()
        {
            ...
            _incomingPackets.Add(ClientPacketHeader.InitializeFloorPlanSessionMessageEvent,
                new InitializeFloorPlanSessionEvent());
            _incomingPackets.Add(ClientPacketHeader.FloorPlanEditorRoomPropertiesMessageEvent,
                new FloorPlanEditorRoomPropertiesEvent());
        }
        ...
        private void RegisterModeration()
        {
            ...
            _incomingPackets.Add(ClientPacketHeader.GetModeratorUserRoomVisitsMessageEvent,
                new GetModeratorUserRoomVisitsEvent());
            ...
            _incomingPackets.Add(ClientPacketHeader.GetModeratorTicketChatlogsMessageEvent,
                new GetModeratorTicketChatlogsEvent());
            ...
            _incomingPackets.Add(ClientPacketHeader.CallForHelpPendingCallsDeletedMessageEvent,
                new CallForHelpPendingCallsDeletedEvent());
