namespace Plus.Communication.Packets.Outgoing.Quests
{
    ...
    {
        public QuestListComposer(GameClient Session, bool Send, Dictionary<string, Quest> UserQuests) : base(
            ServerPacketHeader.QuestListMessageComposer)
        {
        ...
        private void SerializeQuest(ServerPacket Message, GameClient Session, Quest Quest, string Category)
        {
            ...
            Message.WriteInteger(Quest == null
                ? 0
                : (Quest.Category.Contains("xmas2012") ? 0 : Number)); // Quest progress in this cat
            Message.WriteInteger(Quest == null
                ? 0
                : Quest.Category.Contains("xmas2012")
                    ? 0
                    : AmountInCat); // Total quests in this cat
            Message.WriteInteger(Quest == null
                ? 3
