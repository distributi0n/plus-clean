namespace Plus.HabboHotel.Rooms.AI.Types
{
    ...
    internal class BartenderBot : BotAI
    {
        ...
        public BartenderBot(int VirtualId) => this.VirtualId = VirtualId;
        ...
        public override void OnUserSay(RoomUser User, string Message)
        {
            ...
            switch (Response.ResponseType.ToLower())
            {
                ...
                case "whisper":
                    User.GetClient()
                        .SendPacket(new WhisperComposer(GetRoomUser().VirtualId,
                            Response.ResponseText.Replace("{username}", User.GetClient().GetHabbo().Username),
                            0,
                            0));
                    break;
            }
